...
const WeatherDetails: React.FC<IProps> = (props) => {
    ...
    return (
        <>
            <div
                className="wether-details flex flex--column justify-content--center mb--20"
                style={{
                    backgroundImage: `url(${
                        bgImage[details.weather[0].description]
                    })`,
                }}
            >
                <div className="dateWrap flex justify-content--between mt--10 mr--20 ml--20">
                    ...
                    <div className="flex flex--column mr--20">
                        ...
                        <div className="font--semi-bold">
                            {moment(details.dt_txt).format("LLL")}
                        </div>
                    </div>
                </div>
                <div className="flex justify-content--between">
                    ...
                    <div className="flex align-items--center justify-content--evenly width--50">
                        <div className="humidityData flex flex--column">
                            <div className="humidity-title text--white font--semi-bold">
                                HUMIDITY{" "}
                            </div>
                            <div className="value font--semi-bold">
                        ...
                        <div className="humidityData flex flex--column">
                            <div className="humidity-title text--white mr--15 font--semi-bold">
